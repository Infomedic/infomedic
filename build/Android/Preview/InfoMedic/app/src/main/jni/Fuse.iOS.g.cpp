...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\$.uno(1301)
// ----------------------------------------------------------
...
void Blitter::init_DrawCalls()
{
    ...
    _draw_3aa4251e = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseiOS_bundle::Blitterb638ee0c());
}
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(37)
// -------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(53)
// -------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(5)
// ------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\$.uno(785)
// ---------------------------------------------------------
...
NativeTemplate_type* NativeTemplate_typeof()
{
    ...
    ::TYPES[8] = ::g::Fuse::Controls::ParentControl_typeof();
...
bool NativeTemplate::Apply(uObject* obj)
{
    ...
    ::g::Fuse::Controls::ParentControl* parentControl = uAs< ::g::Fuse::Controls::ParentControl*>(obj, ::TYPES[8/*Fuse.Controls.ParentControl*/]);
    ...
    if (parentControl != NULL)
    {
        ...
        if (uIs(parentControl, ::TYPES[11/*Fuse.Controls.Button*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Button::New1());

        if (uIs(parentControl, ::TYPES[12/*Fuse.Controls.Switch*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Switch::New1());

        if (uIs(parentControl, ::TYPES[13/*Fuse.Controls.TextEdit*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::TextInput::New1());

        if (uIs(parentControl, ::TYPES[14/*Fuse.Controls.TextBlock*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::TextBlock::New1());

        if (uIs(parentControl, ::TYPES[15/*Fuse.Controls.Slider*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Slider::New1());

        if (uIs(parentControl, ::TYPES[16/*Fuse.Controls.Image*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Image::New1());

        if (uIs(parentControl, ::TYPES[17/*Fuse.Controls.Rectangle*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Rectangle::New2());

        if (uIs(parentControl, ::TYPES[18/*Fuse.Controls.Circle*/]))
            parentControl->AddStyleChild(::g::Fuse::iOS::Controls::Circle::New2());

        if (uIs(parentControl, ::TYPES[19/*Fuse.Controls.WebView*/]))
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\$.uno(952)
// ---------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(7)
// ------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(14)
// -------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\.uno\$.uno(30)
// -------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Fuse.iOS\0.24.7\$.uno(1083)
// ----------------------------------------------------------
