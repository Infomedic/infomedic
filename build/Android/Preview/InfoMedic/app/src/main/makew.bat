:: This file was generated based on 'C:\ProgramData\Uno\Packages\UnoCore\0.24.5\Targets\CPlusPlus\Android@(Project.Name)\app\src\main\makew.bat'.
...
if exist "%NDK_DIR%\toolchains\arm-linux-androideabi-4.9\prebuilt\windows" (
    ...
    echo ERROR: GCC 4.9, 4.8 or 4.6 was not found in "%NDK_DIR%\toolchains\arm-linux-androideabi-4.**"
    goto ERROR
)
