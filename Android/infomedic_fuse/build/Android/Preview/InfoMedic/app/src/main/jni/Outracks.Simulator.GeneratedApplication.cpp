...
::g::Outracks::Simulator::Application_type* GeneratedApplication_typeof()
{
    ...
    ::STRINGS[0] = uString::Const("10.4.77.199");
    ::STRINGS[1] = uString::Const("127.0.0.1");
    ::STRINGS[2] = uString::Const("C:\\Users\\mmoraf\\Desktop\\InfoMedic\\InfoMedic\\InfoMedic.unoproj");
