// This file was generated based on 'C:\ProgramData\Uno\Packages\UnoCore\0.24.5\Targets\CPlusPlus\Source\Uno\_main.cpp'.
...
namespace g{namespace Fuse{struct Behavior_type; namespace iOS{namespace NativeViews{::g::Fuse::Behavior_type* ParentControl_typeof();}}}}
...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* InfoMedic_FuseControlsPageControl_FuseNode_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* InfoMedic_FuseControlsTextControl_string_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* InfoMedic_FuseNode_bool_IsEnabled_Property_typeof();}
...
namespace g{uClassType* InfoMedic_bundle_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::InfoMedic_bundle_typeof,
        (uType*(*)())&::g::InfoMedic_FuseControlsPageControl_FuseNode_Active_Property_typeof,
        (uType*(*)())&::g::InfoMedic_FuseControlsTextControl_string_Value_Property_typeof,
        (uType*(*)())&::g::InfoMedic_FuseNode_bool_IsEnabled_Property_typeof,
