...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(11)
// ------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Reflection.Uno\0.0.0\$.uno(30)
// --------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(302)
// -------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(394)
// -------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(430)
// -------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Reflection.Uno\0.0.0\$.uno(15)
// --------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(370)
// -------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(483)
// -------------------------------------------------------------------------------------
...
uObject* ObjectTagRegistry::GetFirstObjectWithTag(uString* tag)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(ObjectTagRegistry::GetObjectsWithTag(tag)), ::TYPES[22/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 523);
        }
    }
...
void ObjectTagRegistry::TryExecuteOnObjectsWithTag(uString* tag, uDelegate* action)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(ObjectTagRegistry::GetObjectsWithTag(tag)), ::TYPES[22/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ...
        {
            ::g::Uno::Exception* e = __t.Exception;
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 508);
        }
    }
}
// }

// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(81)
// ------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(566)
// -------------------------------------------------------------------------------------
...
void Selection::Each(uDelegate* action)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Items()), ::TYPES[22/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ...
        {
            ::g::Uno::Exception* e = __t.Exception;
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 587);
        }
    }
}
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Reflection.Uno\0.0.0\$.uno(8)
// -------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Reflection.Uno\0.0.0\$.uno(22)
// --------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(46)
// ------------------------------------------------------------------------------------
...
// ..\..\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno(67)
// ------------------------------------------------------------------------------------
